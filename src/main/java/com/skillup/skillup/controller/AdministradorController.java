...
public class AdministradorController {
    ...
    public String lstarAdministrador(Model model) {
        ...
        List<Usuario> usuarios = (List<Usuario>) usuariosService.findAll();
    ...
    public String filtrarPorRol(@RequestParam("idRol") Integer idRol, Model model) {
        List<Usuario> usuariosFiltrados = usuariosService.findByRol(idRol);
    ...
    public String editar(@PathVariable String id, Model model) {
        Optional<Usuario> usuarios = usuariosService.findById(id);
    ...
    public String actualizar(@PathVariable String id,
        ...
        Usuario usuarioBD = usuariosService.findById(id)
    ...
    public void exportarExcel(@PathVariable("idRol") Integer idRol, HttpServletResponse response) throws IOException {
        ...
        List<Usuario> usuarios = usuariosService.findByRol(idRol);
        ...
        String filename = "Usuario_Rol_" + idRol +  "_" + System.currentTimeMillis() + ".xlsx";
