...
public interface ProgresoModuloRepository extends JpaRepository<ProgresoModulo, Integer> {
    ...
    List<ProgresoModulo> findByIdUsuarioAndModulo_Curso_Id(String idUsuario, Integer idCurso);
    ...
    Long countModulosCompletadosByCurso(@Param("idUsuario") String idUsuario, @Param("idCurso") Integer idCurso);
